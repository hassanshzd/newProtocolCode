...
#define CMT_FCSB_GPIO_PIN           GPIO_Pin_8

#define CMT_SCLK_GPIO               GPIOB
#define CMT_SCLK_GPIO_PIN           GPIO_Pin_13

#define CMT_SDIO_GPIO               GPIOB
#define CMT_SDIO_GPIO_PIN           GPIO_Pin_14
...
#define CMT_GPIO3_GPIO_PIN          GPIO_Pin_10
...
#define PENO2_GPIO                  GPIOE
#define PENO2_GPIO_PIN              GPIO_Pin_9

#define PENO1_GPIO                  GPIOE
#define PENO1_GPIO_PIN              GPIO_Pin_10

#define EV4_GPIO                   	GPIOE
#define EV4_GPIO_PIN               	GPIO_Pin_11

#define EV3_GPIO                   	GPIOE
#define EV3_GPIO_PIN               	GPIO_Pin_12

#define LF_Data_GPIO				GPIOA
#define LF_Data_GPIO_PIN			GPIO_Pin_1

#define LF_Clk_GPIO					GPIOA
#define LF_Clk_GPIO_PIN				GPIO_Pin_0

#define micro_sw1_GPIO			GPIOE
#define micro_sw1_GPIO_PIN	GPIO_Pin_5

#define micro_sw2_GPIO			GPIOE
#define micro_sw2_GPIO_PIN	GPIO_Pin_6

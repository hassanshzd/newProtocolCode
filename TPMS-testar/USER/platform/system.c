...
void Timer3_Config(void) {
    ...
    TIM_TimeBaseStructure.TIM_Period = 288-1;  // 
...
void Timer7_Config(void) {
    ...
    timerInitStructure.TIM_Prescaler = 7200 - 1;         // 72MHz / 7200 = 10kHz
    timerInitStructure.TIM_CounterMode = TIM_CounterMode_Up;
    timerInitStructure.TIM_Period = 2000 - 1;            // 10kHz / 2000 = 5Hz
